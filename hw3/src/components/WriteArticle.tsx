    ...
    return (
        <div id="write-article">
            ...
            {currentTab === "write" ? (
                <>
                    Title
                    <input id="article-title-input" value={title} onChange={(e) => onTitleChange(e.target.value)}></input>
                    <br />
                    Content
                    <textarea
                ...
                <>
                    <div id="article-author">Author: {articleToEdit?.authorName || currentUser?.name}</div>
            ...
            {from === "create" ? (
                <>
                    <button id="back-create-article-button" onClick={() => history.push(backUrl)}>
                        Back
                    </button>
                    <button id="confirm-create-article-button" onClick={onConfirm} disabled={!title || !content}>
                        Confirm
                    </button>
                </>
            ) : (
                <>
                    ...
                    <button id="confirm-edit-article-button" onClick={onConfirm} disabled={!title || !content}>
                        Confirm
                    </button>
                </>
            )}
